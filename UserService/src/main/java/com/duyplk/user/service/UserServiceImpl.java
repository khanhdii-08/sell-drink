package com.duyplk.user.service;

import com.duyplk.user.entity.Role;
import com.duyplk.user.entity.User;
import com.duyplk.user.repository.RoleRepository;
import com.duyplk.user.repository.UserRepository;
